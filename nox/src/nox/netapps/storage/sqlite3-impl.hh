...
/** Default filename for SQLite
 */
#define DEFAULT_SQLITE_FILENAME "testing.sqlite"
/** Check if SQLite file is to be dated, i.e., overwrites default filename
 */
#define DATED_SQLITE_FILENAME false
