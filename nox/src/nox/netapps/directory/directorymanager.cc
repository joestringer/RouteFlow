...
{
    register_event(Principal_rename_event::static_get_name());
    register_event(Principal_delete_event::static_get_name());
    register_event(Group_rename_event::static_get_name());
    register_event(Group_delete_event::static_get_name());
