...
dojo.provide("nox.netapps.directory.directorymanagerws.Directories");
        ...
        dojo.forEach(principal_types, function (ptype) {
            ...
            var a = {
                ...
                onError: function (error) {
                    console_log("Error occured in nox.netapps.directory.directorymanagerws.Directories._determine_primaries_and_defaults() while attempting read fetch.");
                }
            };
            ...
            a = {
                ...
                onError: function (error) {
                    console_log("Error occured in nox.netapps.directory.directorymanagerws.Directories._determine_primaries_and_defaults() while attempting write fetch.");
                }
            };
            a.query["write_" + ptype + "_enabled"] = true;
            d.datastore.fetch(a);
            dojo.publish("update_completions", ["nox.netapps.directory.directorymanagerws.Directories"]);
        });
    };
...
dojo.addOnLoad(nox.netapps.directory.directorymanagerws.Directories.page_init);
