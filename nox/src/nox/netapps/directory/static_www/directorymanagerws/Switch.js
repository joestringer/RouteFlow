...
dojo.provide("nox.netapps.directory.directorymanagerws.Switch");
...
dojo.require("nox.netapps.directory.directorymanagerws.SwitchPortStore");
dojo.require("nox.netapps.directory.directorymanagerws.SwitchGroupStore");
dojo.require("nox.uiapps.coreui.coreui.UpdateMgr");
dojo.require("dijit.form.FilteringSelect");
dojo.require("dojo.data.ItemFileReadStore");
dojo.require("dijit.Dialog"); 
dojo.require("nox.uiapps.default_switch_approval.switch_approval.SwitchApprover");

dojo.declare("nox.netapps.directory.directorymanagerws.Switch", [ nox.netapps.directory.directorymanagerws._Principal ], {
    ...
    set_approval: function(is_approved, onComplete) {
        var updatemgr =  nox.uiapps.coreui.coreui.getUpdateMgr();  
        ...
        updatemgr.rawXhrPut({
            ...
            load: dojo.hitch(this, function (response, ioArgs) {
                      nox.uiapps.coreui.coreui.getUpdateMgr().updateNow();
                      if(onComplete != null) 
                          onComplete(this); 
                      return null; 
            })
...
dojo.declare("nox.netapps.directory.directorymanagerws.SwitchUtil", [], {
...
show_switch_reg_dialog : function(switch_obj,props) { 
                  ...
                  appr = new nox.uiapps.default_switch_approval.switch_approval.SwitchApprover(props);
...
(function () {
    ...
    nox.netapps.directory.directorymanagerws.getSwitchUtil = function () {
        if (switch_util == null) {
            switch_util = new nox.netapps.directory.directorymanagerws.SwitchUtil();
        }
        return switch_util;
    }
})();
