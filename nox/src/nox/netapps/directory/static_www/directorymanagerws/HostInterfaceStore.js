...
dojo.provide("nox.netapps.directory.directorymanagerws.HostInterfaceStore");

dojo.require("nox.uiapps.coreui.coreui._UpdatingStore");
dojo.require("nox.netapps.directory.directorymanagerws.HostInterface");
dojo.require("dojo.data.util.simpleFetch");

dojo.declare("nox.netapps.directory.directorymanagerws.HostInterfaceStore", [ nox.uiapps.coreui.coreui._UpdatingStore ], {
...
dojo.extend(nox.netapps.directory.directorymanagerws.HostInterfaceStore,
