...
dojo.provide("nox.netapps.directory.directorymanagerws.PrincipalListFilter");

dojo.require("nox.uiapps.coreui.coreui.ListTableHelper"); 
...
var u = nox.netapps.directory.directorymanagerws.PrincipalListFilter;
...
u.init_principal_list_page = function(ptype) {
  ...
  return new nox.uiapps.coreui.coreui.ListTableHelper({ 
      filters : [
