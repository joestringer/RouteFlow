...
dojo.provide("nox.netapps.directory.directorymanagerws.User");
...
dojo.declare("nox.netapps.directory.directorymanagerws.User", [ nox.netapps.directory.directorymanagerws._Principal ], {
    ...
    saveCred: function(pwd, kwarg) {
        ...
        if (kwarg != null &&  kwarg["errorHandlers"] != null) {
            ...
            errHandlers = {
                400: function(response, ioArgs, item, itemType) {
                    nox.uiapps.coreui.coreui.UpdateErrorHandler.showError(response.responseText,
