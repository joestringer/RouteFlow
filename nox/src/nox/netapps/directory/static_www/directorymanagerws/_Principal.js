...
dojo.provide("nox.netapps.directory.directorymanagerws._Principal");
...
dojo.declare("nox.netapps.directory.directorymanagerws._Principal",
             [ nox.uiapps.coreui.coreui._NamedEntity ], {
    ...
    uiMonitorLink: function ( /*optional*/use_mangled) {
        ...
        if (p == null)
            ...
            return nox.uiapps.coreui.coreui.base.createLink(p, name);
    },
    ...
    _do_modify_request : function(path, method, onComplete) {
        var coreui = nox.uiapps.coreui.coreui;
    ...
    delete_binding : function(onComplete) { 
          ...
          coreui.getUpdateMgr().xhr("DELETE", {
              ...
              handleAs: "json",
              recur: false,
              error: nox.uiapps.coreui.coreui.UpdateErrorHandler.create()
          });
    }
});

dojo.declare("nox.netapps.directory.directorymanagerws.PrincipalUtil", [], {
    ...
    get_listpage_store_error_handler : function(type_plural) { 
      return  function(error, ioArgs, item, update_type) {
              var ueh = nox.uiapps.coreui.coreui.UpdateErrorHandler; 
