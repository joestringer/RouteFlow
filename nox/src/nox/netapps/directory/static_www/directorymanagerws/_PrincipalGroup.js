...
dojo.provide("nox.netapps.directory.directorymanagerws._PrincipalGroup");

dojo.require("nox.uiapps.coreui.coreui.base");
...
dojo.declare("nox.netapps.directory.directorymanagerws._PrincipalGroup", [ nox.uiapps.coreui.coreui._NamedEntity ], {

    coreui: nox.uiapps.coreui.coreui,
    ...
    uiMonitorLink: function ( /*optional*/use_mangled) {
        ...
        return nox.uiapps.coreui.coreui.base.createLink(this.uiMonitorPath(),name);
    },
    ...
    full_rename : function (arg) {
        ...
        onNonexisting = function () {
            nox.uiapps.coreui.coreui.getUpdateMgr().rawXhrPut({
                  url: this.wsv1Path(),
    ...
    exists : function(onComplete) { 
        nox.uiapps.coreui.coreui.getUpdateMgr().xhrGet( {
            url: this.wsv1Path(),
            headers: { "content-type": "application/json" },
    ...
    _do_modify_request : function(path, method, onComplete) {
        nox.uiapps.coreui.coreui.getUpdateMgr().xhr(method, {
            url: path,
            headers: { "content-type": "application/json" },
            putData: dojo.toJson({}),
            load: function (response, ioArgs) {
   ...
   track_counts : function() { 
    ...
    saveGroup: function (kwarg) {
        ...
        if (kwarg != null &&  kwarg["errorHandlers"] != null) {
            ...
            errHandlers = {
                400: function(response, ioArgs, item, itemType) {
                    nox.uiapps.coreui.coreui.UpdateErrorHandler.showError(
...
dojo.declare("nox.netapps.directory.directorymanagerws.PrincipalGroupUtil", [], {
    ...
    show_modify_dialog : function(ptype, group, type, title, ctor) {
        ...
        appr = new nox.netapps.directory.directorymanagerws.GroupModifyDialog(props);
