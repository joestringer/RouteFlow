...
dojo.provide("nox.netapps.directory.directorymanagerws.NWAddrGroup");
dojo.require("nox.netapps.directory.directorymanagerws._PrincipalGroup");
dojo.require("nox.netapps.directory.directorymanagerws.NWAddrStore");
dojo.require("nox.netapps.directory.directorymanagerws.NWAddrGroupStore");

dojo.declare("nox.netapps.directory.directorymanagerws.NWAddrGroup", [ nox.netapps.directory.directorymanagerws._PrincipalGroup ], {
