...
dojo.provide("nox.netapps.directory.directorymanagerws.HostBinding");

dojo.require("nox.uiapps.coreui.coreui._UpdatingItem");

dojo.declare("nox.netapps.directory.directorymanagerws.HostBinding", [ nox.uiapps.coreui.coreui._UpdatingItem ], {
