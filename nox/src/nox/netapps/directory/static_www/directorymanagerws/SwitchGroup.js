...
dojo.provide("nox.netapps.directory.directorymanagerws.SwitchGroup");

dojo.require("nox.netapps.directory.directorymanagerws._PrincipalGroup");
dojo.require("nox.netapps.directory.directorymanagerws.SwitchStore");
dojo.require("nox.netapps.directory.directorymanagerws.SwitchGroupStore");

dojo.declare("nox.netapps.directory.directorymanagerws.SwitchGroup", [ nox.netapps.directory.directorymanagerws._PrincipalGroup ], {
