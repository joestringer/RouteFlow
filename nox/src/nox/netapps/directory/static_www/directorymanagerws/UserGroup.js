...
dojo.provide("nox.netapps.directory.directorymanagerws.UserGroup");
...
dojo.declare("nox.netapps.directory.directorymanagerws.UserGroup", [ nox.netapps.directory.directorymanagerws._PrincipalGroup ], {
    ...
    parentGroupStore: function (kwarg) {
        return new nox.netapps.directory.directorymanagerws.UserGroupStore(dojo.mixin(kwarg, {
            url: this.wsv1Path() + "/parent"
        }));
    },

    principalMemberStore: function (kwarg) {
        return new nox.netapps.directory.directorymanagerws.UserStore(dojo.mixin(kwarg, {
