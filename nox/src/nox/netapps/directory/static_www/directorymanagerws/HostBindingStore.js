...
dojo.provide("nox.netapps.directory.directorymanagerws.HostBindingStore");

dojo.require("nox.uiapps.coreui.coreui._UpdatingStore");
dojo.require("nox.uiapps.coreui.coreui.UpdateMgr");
dojo.require("nox.netapps.directory.directorymanagerws.HostBinding");
dojo.require("dojo.data.util.simpleFetch");

dojo.declare("nox.netapps.directory.directorymanagerws.HostBindingStore", [ nox.uiapps.coreui.coreui._UpdatingStore ], {
...
dojo.extend(nox.netapps.directory.directorymanagerws.HostBindingStore,dojo.data.util.simpleFetch);
