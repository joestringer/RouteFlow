...
dojo.provide("nox.netapps.directory.directorymanagerws.PrincipalInfoEditUtils");

dojo.require("nox.netapps.directory.directorymanagerws.Directories"); 

(function () {

var u = nox.netapps.directory.directorymanagerws.PrincipalInfoEditUtils;
...
u.get_directory_row = function(ptype, dirname,is_editable) {
  ...
  var validate_dir_fn = function() { 
    ...
    var store = nox.netapps.directory.directorymanagerws.Directories.datastore;  
    if(v == dirname) 
      return true; 
