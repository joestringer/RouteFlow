...
from nox.netapps.authenticator import pynamemanager
...
UNAUTHENTICATED = pynamemanager.NameManager.get_unauthenticated_name()
# principal is authenticated but more specific name is unknown
AUTHENTICATED   = pynamemanager.NameManager.get_authenticated_name()
# don't know principal's name (for throwing auth events)
UNKNOWN         = pynamemanager.NameManager.get_unknown_name()
