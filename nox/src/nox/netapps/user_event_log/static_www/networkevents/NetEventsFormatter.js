 ...
 */
dojo.provide("nox.netapps.user_event_log.networkevents.NetEventsFormatter");

dojo.require("nox.netapps.directory.directorymanagerws.User");
dojo.require("nox.netapps.directory.directorymanagerws.Switch");
dojo.require("nox.netapps.directory.directorymanagerws.Host");
dojo.require("nox.netapps.directory.directorymanagerws.HostGroup");
dojo.require("nox.netapps.directory.directorymanagerws.UserGroup");
dojo.require("nox.netapps.directory.directorymanagerws.LocationGroup");

// switch groups are not implemented yet
//dojo.require("nox.netapps.directory.directorymanagerws.SwitchGroup");

(function() {

    var nef = nox.netapps.user_event_log.networkevents.NetEventsFormatter;
