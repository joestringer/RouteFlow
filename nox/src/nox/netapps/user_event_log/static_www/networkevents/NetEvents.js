...
dojo.provide("nox.netapps.user_event_log.networkevents.NetEvents");
dojo.require("nox.uiapps.coreui.coreui.UpdateMgr");
dojo.require("nox.netapps.user_event_log.networkevents.NetEventsFormatter");

dojo.declare("nox.netapps.user_event_log.networkevents.NetEventsTable", [], {
  ...
  _new_item : function(item) {
    ...
    "'>" + nox.netapps.user_event_log.networkevents.NetEventsFormatter.format_msg(item.msg) + "</td>";
  },
